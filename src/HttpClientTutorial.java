...
public class HttpClientTutorial {
    ...
    private static void getStats() throws IOException, InterruptedException {
        HttpResponse<String> response = doRequest("/stats", "", "GET");
        System.out.println(response.body());
    }

    private static void getStatus() throws IOException, InterruptedException {
    ...
    private static void doGuess(String userInput) throws IOException, InterruptedException {
